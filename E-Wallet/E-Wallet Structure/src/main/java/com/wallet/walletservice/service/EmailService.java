...
import com.wallet.walletservice.Util.EmailUtil;
...
public class EmailService {
    ...
    public static  final String FROM_EMAIL = "blablabla@1gmail.com"; //requires valid gmail id
    public static final String PASSWORD = "i_won't_tell_you"; // correct password for gmail id


    public static void sendEmail(String toEmail) {
        //final String toEmail = "abcd@gmail.com"; // can be any email id

        Properties props = getProperties();
        Authenticator auth = getAuthenticator();
        Session session = Session.getDefaultInstance(props, auth);
        logger.info("Session created");
        EmailUtil.sendEmail(session, toEmail,"Mail from e-wallet", "Transaction_History");
    }
    ...
    public static void sendEmailWithAttachments(String host, String port, final String userName, final String password,
        ...
        // attachFiles --> it is the fileWriter in TransactionResource class inside TranHistoryToEmail function
